      ...
      {areas.length > 1 && (
        <>
          <button
            ...
            className="absolute top-1/2 left-5 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-forest-green/55 text-xl text-cream"
          >
            ‹
          </button>
          <button
            ...
            className="absolute top-1/2 right-5 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-forest-green/55 text-xl text-cream"
          >
            ›
          </button>
